...
export default function AutomationRulesPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Rules Engine"
        description="Configure regras automáticas com condições e ações"
        actions={
      ...
      {rules && rules.length > 0 ? (
                              ...
                              {actionsArr.length > 0 ? (
                                actionsArr.map((a: any, aIdx: number) => (
                                  ...
                                  >
                                    ...
                                    {a.config && (
                                      <span className="text-muted-foreground">→ {a.config}</span>
                                    )}
                                  </div>
                                ))
                              ) : (
                                <p className="text-xs text-muted-foreground">Nenhuma ação definida</p>
                              )}
                            </div>
                          </div>
                        </motion.div>
        ...
        <Card className="surface-glow">
          <CardContent className="py-16 text-center">
            ...
            <p className="text-muted-foreground mb-2">Nenhuma regra de automação criada.</p>
